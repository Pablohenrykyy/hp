...
# OPÇÃO 1
````
apt install wget -y; bash <(wget -qO- raw.githubusercontent.com/Pablohenrykyy/hp/main/ssh-plus)
````

# OPÇÃO 2
```
bash <(wget -qO- raw.githubusercontent.com/Pablohenrykyy/hp/main/ssh-plus)
...
````
wget https://raw.githubusercontent.com/Pablohenrykyy/hp/main/script/64/ssh-plus ; chmod +x Plus ; ./Plus
````
